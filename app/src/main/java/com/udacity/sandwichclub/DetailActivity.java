...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this)
                ...
                .placeholder(R.drawable.sandwich_img_placeholder)
                .error(R.drawable.sandwich_img_error)
                .into(ingredientsIv);
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        ingredientsTV.setText(JsonUtils.arrayToString(sandwich.getIngredients()));

        TextView akaTV = (TextView) findViewById(R.id.also_known_tv);
        akaTV.setText(JsonUtils.arrayToString(sandwich.getAlsoKnownAs()));
    }
}
